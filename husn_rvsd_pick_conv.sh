...
orig_pkfl="husn_Jun19-Apr20_picks.txt"
fnl_pkfl="husn_Jun19-Apr20.pick"
ev_infofl="husn_Jun19-Apr20_evinfo.txt"
...
#   echo ${dte[2]}
    ...
    d_o=${dte[2]}
        ...
        if [ "${pick_arr[3]:0:1}" == "P" ] || [ "${pick_arr[3]:0:1}" == "S" ]; then
            ...
            echo ${stnm} ? ${comp} ? ${phz} ? ${dyt_fnl} ${hrm_fnl} ${ss_fnl} GAU ${ph_err}e+00 -1.00e+00 -1.00e+00 -1.00e+00 >> ${fnl_pkfl}
        fi
    done < test.txt
    echo " " >> ${fnl_pkfl}
done < ${ev_infofl}